 ...
 * 
 */
public class MouseIn extends Mouse {
    static {
        System.loadLibrary("MouseIn");
        initIDs();
    }
    ...
    public MouseIn(int b, EvasPoint o, EvasCoordPoint c, Object d, long t, EvasEventFlags ef, EvasObject es) {
        super(o, c, d, t, ef, es);
        this.buttons = b;
    }
